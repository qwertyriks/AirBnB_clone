...
class TestPlace_instantiation(unittest.TestCase):
    """Unit testing for testing instantiation of the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unit testing for testing save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unit testing for testing to_dict method of the Place class."""
