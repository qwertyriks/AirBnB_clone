...
class TestUser_instantiation(unittest.TestCase):
    """Unit testing for testing instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """Unit testing for testing save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unit testing for testing to_dict method of the User class."""
